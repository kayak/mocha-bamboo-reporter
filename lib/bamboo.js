...
function clean(test) {
    ...
    /** fields title, fullTitle, duration cannot be changed, otherwise wont work in bamboo UI
     * but change other fields to whatever you need.
     *  **/
  var o = {
     fullTitle: relativeFileName
    ,title: test.customTitle || test.fullTitle()
